...
5. Choose Complete without follow-up, or Complete and book follow-up. The latter uses the same available-slot picker and reserves staff/student time atomically. There is no editable time field. Later Save book feedback records structured reading/enjoyment with its source; a return is not evidence of finishing.
6. My day lists follow-ups for the original facilitator and assigned follow-up staff. Start and explicitly complete the linked follow-up conversation to record contact. Cancel/no-show releases the reservation without counting contact; Book a slot rebooks the outstanding obligation.
7. Outcomes → Librarian activity shows session counts and supporting tables. End dates are exclusive; new choices remain pending their 14-day observation window. Outcomes → Student progress rolls up the same borrowing counts, English grades and compatible reading checks as individual Students, with separate extract and illustrative scenario sources. Portfolio progress is not attributed to a librarian.
