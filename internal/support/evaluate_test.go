...
func TestDemoFixtures(t *testing.T) {
	...
	for id, want := range map[string]string{"S-406": None, "S-402": None, "S-405": Soon, "S-509": Soon, "S-504": None, "S-510": None, "S-305": None, "S-301": Soon} {
		r := ac.ByStudent[id]
		r.StudentID = id
